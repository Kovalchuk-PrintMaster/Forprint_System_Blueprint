...
def test_prompt_contract_is_active_after_step20_acceptance() -> None:
    ...
    assert current_id in {step21_id, step22_id, step23_id, step24_id, "blueprint_v0_4_review_roadmap_queue_transaction_v0_1", "blueprint_v0_4_next_prompt_selection_and_activation_v0_1", "blueprint_v0_4_tracking_events_reference_v0_1"}
    ...
    if current_id in {step23_id, step24_id}:
    ...
    elif current_id == step24_id:
        step23 = record(roadmap["steps"], "step_id", step23_id)
        prompt23 = record(queue["prompts"], "prompt_id", step23_id)
        prompt24 = record(queue["prompts"], "prompt_id", step24_id)
