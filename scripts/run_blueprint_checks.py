...
def build_checks() -> list[CheckDefinition]:
    ...
    return [
        ...
        CheckDefinition(
            ...
            title="Coordination document manifest",
            expected_result="Coordination document manifest builds without writing generated reports",
            command=[
                python,
        ...
        CheckDefinition(
            ...
            title="Coordination awareness dashboard",
            expected_result="Coordination document awareness dashboard renders for Library",
            command=[
                python,
        ...
        CheckDefinition(
            ...
            title="Coordination context bundle",
            expected_result="Coordination context bundle builds without writing generated files",
            command=[
                python,
