...
- [ForPrint CRM](modules/forprint_crm.yaml) — 24 captured human-intent entries.
...
- [Telegram Bot](modules/telegram_bot.yaml) — 45 captured human-intent entries.
...
- [Logistics Service](modules/logistics_service.yaml) — 12 captured human-intent entries.
...
- [ForPrint Marketing Orchestrator](modules/forprint_marketing_orchestrator.yaml) — 9 captured human-intent entries.
- [Cloud Backup Manager](modules/cloud_backup_manager.yaml) — 6 captured human-intent entries.
- [ForPrint Verification Lab](modules/verification_lab.yaml) — 3 captured human-intent entries.
