...
Canonical architecture: machine/, accepted ADRs, global policy, module policy.
...
Do not mass-move or delete files until automated reference checks, source-of-truthclassification and compatibility aliases are in place.
