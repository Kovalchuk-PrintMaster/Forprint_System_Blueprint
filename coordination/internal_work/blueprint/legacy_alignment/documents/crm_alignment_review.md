...
From Operations Control Registry
clients;
orders;
order statuses;
operational tasks;
...
operations_control_registry_to_crm_dashboard_snapshot.v1
...
Confirm Operations Control Registry as canonical owner of clients, orders, tasks and operational statuses.
...
confirm Operations Control Registry canonical ownership
